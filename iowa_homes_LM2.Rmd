...
```{r Load Data}
# training data set
iowa.homes <- read.csv("../house-prices-data/train.csv", header=TRUE, sep=",") 
...
```{r}
dat.test.valid <- read.csv("../house-prices-data/test.csv", header=TRUE, sep=",")
dat.saleprice <- read.csv("../house-prices-data/sample_submission.csv")
